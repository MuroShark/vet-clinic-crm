...
namespace AhillBackend.Data
{
    public static class DbInitializer
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            var empChief = new Employee { FullName = "Соколов Андрей Петрович", Phone = "+7 (495) 111-2201", Email = "sokolovap@ahill.ru", BranchId = brCentral.BranchId, PositionId = posChief.PositionId, HireDate = hireDate, KPIRate = 0.35m, IsActive = true };
            var empDirector = new Employee { FullName = "Абрамов Дмитрий Александрович", Phone = "+7 (495) 111-2202", Email = "abramovda@ahill.ru", BranchId = brCentral.BranchId, PositionId = posDirector.PositionId, HireDate = hireDate, KPIRate = 0.30m, IsActive = true };
            var empTherapist = new Employee { FullName = "Карабанова Елена Александровна", Phone = "+7 (495) 111-2203", Email = "karabanovaea@ahill.ru", BranchId = brCentral.BranchId, PositionId = posTherapist.PositionId, HireDate = hireDate, KPIRate = 0.25m, IsActive = true };
            var empAdmin = new Employee { FullName = "Бенидзе Елизавета Игоревна", Phone = "+7 (495) 111-2204", Email = "benidzeei@ahill.ru", BranchId = brCentral.BranchId, PositionId = posAdmin.PositionId, HireDate = hireDate, KPIRate = 0.00m, IsActive = true };
            var empSurgeon = new Employee { FullName = "Фридман Артём Игоревич", Phone = "+7 (495) 111-2205", Email = "fridmanai@ahill.ru", BranchId = brCentral.BranchId, PositionId = posSurgeon.PositionId, HireDate = hireDate, KPIRate = 0.30m, IsActive = true };
            var empOncologist = new Employee { FullName = "Юпатова Екатерина Владимировна", Phone = "+7 (495) 111-2206", Email = "yupatovaev@ahill.ru", BranchId = brCentral.BranchId, PositionId = posOncologist.PositionId, HireDate = hireDate, KPIRate = 0.28m, IsActive = true };
            var empRatologist = new Employee { FullName = "Брюхно Виктор Васильевич", Phone = "+7 (495) 111-2207", Email = "bryuhnovv@ahill.ru", BranchId = brNorth.BranchId, PositionId = posRatologist.PositionId, HireDate = hireDate, KPIRate = 0.27m, IsActive = true };
